                ...
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <p class="fs-5">Take Bootstrap to the next level with premium themes from the
                            <a href="#"> official Bootstrap Themes Marketplace</a>. Themes are built on Bootstrap
                            as their
                ...
                <div class="row">
                    <div class="col-lg-3 mb-5">
                        <a href="" class="logo text-decoration-none">
                            <div class="d-flex">
                                <img src="{{ Vite::asset('resources/images/logo-black.svg') }}" alt=""
                                    class="img-fluid" style="width: 40px;">
                                <div class="fs-5 ms-2 text-black">Bootstrap</div>
                            </div>
                        </a>
                        <div class="mt-2 text-muted">
                            <small>Designed and built with all the love in world by the <a href="">Bootstrap
                                    Team</a> with the help of <a href="" class="text-black">our
